...
AUTOSAVE_AUTOTUNE_CACHE = os.getenv('OGNN_AUTOSAVE_AUTOTUNE', '1') == '1'
AUTOTUNE_CACHE_PATH = os.getenv(
    'OGNN_AUTOTUNE_CACHE_PATH',
    os.path.expanduser('~/.ognn/autotune_cache.json'))
...
def get_autotune_cache():
    ...
    walk_package('ognn.kernels', save_cache)
...
def load_autotune_cache(path_or_cache=None):
    ...
    walk_package('ognn.kernels', load_cache)
